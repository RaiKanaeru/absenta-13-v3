...
export const TEMPLATE_PATHS = {
    ...
    REKAP_KELAS_X: path.join(TEMPLATE_BASE, `REKAP KETIDAKHADIRAN KELAS X ${TAHUN_PELAJARAN}.xlsx`),
    REKAP_KELAS_XI: path.join(TEMPLATE_BASE, `REKAP KETIDAKHADIRAN KELAS XI ${TAHUN_PELAJARAN}.xlsx`),
    REKAP_KELAS_XII: path.join(TEMPLATE_BASE, `REKAP KETIDAKHADIRAN KELAS XII ${TAHUN_PELAJARAN}.xlsx`),
    REKAP_KELAS_XIII: path.join(TEMPLATE_BASE, `REKAP KETIDAKHADIRAN KELAS XIII ${TAHUN_PELAJARAN}.xlsx`),
    
    // Rekap Guru Tahunan
    REKAP_GURU: path.join(TEMPLATE_BASE, `REKAP KETIDAKHADIRAN GURU ${TAHUN_PELAJARAN}.xlsx`),
    
    // Presensi Siswa (optional)
    PRESENSI_SISWA: path.join(TEMPLATE_BASE, `PRESENSI SISWA ${TAHUN_PELAJARAN} edit1.xlsx`),
    
    // Jadwal (optional)
    JADWAL: path.join(TEMPLATE_BASE, `JADWAL PELAJARAN ${TAHUN_PELAJARAN} (REVISI 2) (1).xlsx`)
};
