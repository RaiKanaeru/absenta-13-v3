...
// Refactored Imports
import { initializeDatabase } from './services/system/initializer.js';
import { setupRoutes } from './routes/appRoutes.js';

// Middleware & Utils Imports
import { requestIdMiddleware, notFoundHandler, globalErrorHandler } from './middleware/globalErrorMiddleware.js';
import { formatWIBTime, getWIBTimestamp } from './utils/timeUtils.js';
import { 
    diagnoseCORS, 
    formatCORSErrorLog, 
    createCORSErrorResponse,
    CORS_ERROR_CODES 
} from './utils/corsErrorHandler.js';
