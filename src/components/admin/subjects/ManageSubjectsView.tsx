...
import { ArrowLeft, Download, BookOpen, Search, Edit, Trash2 } from "lucide-react";
  ...
  if (showImport) {
    return (
      <React.Suspense fallback={<div>Loading...</div>}>
        <ExcelImportView entityType="mapel" entityName="Mata Pelajaran" onBack={() => setShowImport(false)} />
      </React.Suspense>
    );
  }
