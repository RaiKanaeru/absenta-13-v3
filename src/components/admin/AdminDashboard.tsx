...
const ManageStudentsView = React.lazy(() => import('./students/ManageStudentsView').then(module => ({ default: module.ManageStudentsView })));
const ManageStudentDataView = React.lazy(() => import('./students/ManageStudentDataView'));
const StudentPromotionView = React.lazy(() => import('./students/StudentPromotionView').then(module => ({ default: module.StudentPromotionView })));
const ManageTeacherAccountsView = React.lazy(() => import('./teachers/ManageTeacherAccountsView'));
const ManageTeacherDataView = React.lazy(() => import('./teachers/ManageTeacherDataView'));
const ManageSubjectsView = React.lazy(() => import('./subjects/ManageSubjectsView').then(module => ({ default: module.ManageSubjectsView })));
const ManageClassesView = React.lazy(() => import('./classes/ManageClassesView').then(module => ({ default: module.ManageClassesView })));
const ManageRoomsView = React.lazy(() => import('./rooms/ManageRoomsView').then(module => ({ default: module.ManageRoomsView })));
const ManageSchedulesView = React.lazy(() => import('./schedules/ManageSchedulesView'));
const JamPelajaranConfig = React.lazy(() => import("./JamPelajaranConfig"));
const SimpleRestoreView = React.lazy(() => import("./SimpleRestoreView"));
const EditProfile = React.lazy(() => import('@/components/shared/EditProfile').then(module => ({ default: module.EditProfile })));
const ReportLetterheadSettings = React.lazy(() => import('./settings/ReportLetterheadSettings'));
const ReportsView = React.lazy(() => import('./reports/ReportsView').then(module => ({ default: module.ReportsView })));
const LiveSummaryView = React.lazy(() => import('./dashboard/LiveSummaryView').then(module => ({ default: module.LiveSummaryView })));
