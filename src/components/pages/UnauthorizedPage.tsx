    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 flex items-center justify-center p-4">
            ...
            <div className="absolute inset-0 overflow-hidden">
                ...
                <div className="absolute bottom-1/4 right-1/4 w-64 h-64 bg-cyan-400/10 rounded-full blur-3xl"></div>
            </div>

            <div className="relative z-10 max-w-md w-full text-center">
                {/* Lock/Shield Icon */}
                <div className="mb-8">
                    <div className="mx-auto w-28 h-28 bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-full flex items-center justify-center border border-blue-400/20 shadow-2xl">
                ...
                {/* Info box */}
                <div className="bg-blue-500/10 border border-blue-400/20 rounded-xl p-4 mb-8">
                ...
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                    <Button
                        onClick={() => navigate(-1)}
                        variant="outline"
                        className="bg-white/5 border-blue-400/20 text-white hover:bg-white/10"
                    >
                ...
                {/* Footer */}
                <p className="mt-10 text-blue-300/40 text-sm">
