...
export default {
  ...
  columns: [
    ...
    { key: 'tanggal_pengajuan', label: 'Tanggal Pengajuan', width: 18, align: 'center', format: 'date' },
    { key: 'tanggal_absen', label: 'Tanggal Absen', width: 18, align: 'center', format: 'date' },
    ...
    { key: 'alasan_banding', label: 'Alasan Banding', width: 25, align: 'left' },
    { key: 'catatan_guru', label: 'Catatan Guru', width: 25, align: 'left' },
    { key: 'tanggal_keputusan', label: 'Tanggal Keputusan', width: 18, align: 'center', format: 'date' },
